...
async function main() {
    ...
    const driverUser3 = await prisma.user.upsert({
        where: { email: 'ornellasimbibeza@gmail.com' },
        update: {},
        create: {
            firstName: 'Ornella',
            lastName: 'Simbibeza',
            name: 'Ornella Simbibeza',
            email: 'ornellasimbibeza@gmail.com',
            password: driverPassword,
            phone: '+250788000444',
            role: 'DRIVER',
            status: 'ACTIVE'
    ...
    const vehicles = [
        { plateNumber: 'RAB 123A', type: 'van', capacity: 1500, status: 'AVAILABLE', fuelType: 'diesel', vehicleModel: 'Toyota HiAce', year: 2022 },
        { plateNumber: 'RAC 456B', type: 'truck', capacity: 5000, status: 'AVAILABLE', fuelType: 'diesel', vehicleModel: 'Isuzu NQR', year: 2021 },
        { plateNumber: 'RAD 789C', type: 'van', capacity: 2000, status: 'AVAILABLE', fuelType: 'diesel', vehicleModel: 'Mercedes Sprinter', year: 2023 },
        { plateNumber: 'RAE 012D', type: 'truck', capacity: 8000, status: 'AVAILABLE', fuelType: 'diesel', vehicleModel: 'Mitsubishi Canter', year: 2020 },
        { plateNumber: 'RAF 345E', type: 'pickup', capacity: 1000, status: 'AVAILABLE', fuelType: 'petrol', vehicleModel: 'Toyota Hilux', year: 2023 },
        { plateNumber: 'RAG 678F', type: 'van', capacity: 1800, status: 'MAINTENANCE', fuelType: 'diesel', vehicleModel: 'Ford Transit', year: 2021 },
        { plateNumber: 'RAH 901G', type: 'truck', capacity: 10000, status: 'AVAILABLE', fuelType: 'diesel', vehicleModel: 'Hino 300', year: 2022 },
        { plateNumber: 'RAI 234H', type: 'motorcycle', capacity: 50, status: 'AVAILABLE', fuelType: 'petrol', vehicleModel: 'Honda CG125', year: 2023 },
    ];
